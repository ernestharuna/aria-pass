    ...
    return (
        <section className="bg-[#F1F2F9] py-3 relative">
            <div className="container mx-auto font-light md:w-max text-sm flex gap-3 items-start">
                ...
                <span>Music theory courses coming soon to AriaPass. <br className='md:hidden' /> <b className="font-semibold inline-block mt-1 md:mt-0">Get Notified <ArrowRight size={14} className="inline-block -top-[2px] left-1 relative" /></b></span>
            </div>
